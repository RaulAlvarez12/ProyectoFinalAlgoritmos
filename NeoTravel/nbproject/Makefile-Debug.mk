...
${OBJECTDIR}/CiudadData.o: CiudadData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CiudadData.o CiudadData.cpp
...
${OBJECTDIR}/VentanaActualizarAerolinea.o: VentanaActualizarAerolinea.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaActualizarAerolinea.o VentanaActualizarAerolinea.cpp

${OBJECTDIR}/VentanaActualizarAvionLista.o: VentanaActualizarAvionLista.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaActualizarAvionLista.o VentanaActualizarAvionLista.cpp

${OBJECTDIR}/VentanaActualizarAvionVuelo.o: VentanaActualizarAvionVuelo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaActualizarAvionVuelo.o VentanaActualizarAvionVuelo.cpp

${OBJECTDIR}/VentanaActualizarCiudad.o: VentanaActualizarCiudad.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaActualizarCiudad.o VentanaActualizarCiudad.cpp

${OBJECTDIR}/VentanaActualizarHorario.o: VentanaActualizarHorario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaActualizarHorario.o VentanaActualizarHorario.cpp

${OBJECTDIR}/VentanaActualizarVuelo.o: VentanaActualizarVuelo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaActualizarVuelo.o VentanaActualizarVuelo.cpp

${OBJECTDIR}/VentanaAgregarAerolinea.o: VentanaAgregarAerolinea.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaAgregarAerolinea.o VentanaAgregarAerolinea.cpp

${OBJECTDIR}/VentanaAgregarAvion.o: VentanaAgregarAvion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaAgregarAvion.o VentanaAgregarAvion.cpp

${OBJECTDIR}/VentanaAgregarCiudad.o: VentanaAgregarCiudad.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaAgregarCiudad.o VentanaAgregarCiudad.cpp

${OBJECTDIR}/VentanaAgregarHorario.o: VentanaAgregarHorario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaAgregarHorario.o VentanaAgregarHorario.cpp

${OBJECTDIR}/VentanaAgregarVuelo.o: VentanaAgregarVuelo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaAgregarVuelo.o VentanaAgregarVuelo.cpp

${OBJECTDIR}/VentanaBuscarAerolinea.o: VentanaBuscarAerolinea.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaBuscarAerolinea.o VentanaBuscarAerolinea.cpp

${OBJECTDIR}/VentanaBuscarAvion.o: VentanaBuscarAvion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaBuscarAvion.o VentanaBuscarAvion.cpp

${OBJECTDIR}/VentanaBuscarCiudad.o: VentanaBuscarCiudad.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaBuscarCiudad.o VentanaBuscarCiudad.cpp

${OBJECTDIR}/VentanaBuscarHorario.o: VentanaBuscarHorario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaBuscarHorario.o VentanaBuscarHorario.cpp

${OBJECTDIR}/VentanaBuscarVuelo.o: VentanaBuscarVuelo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaBuscarVuelo.o VentanaBuscarVuelo.cpp
...
${OBJECTDIR}/VentanaEliminarAerolinea.o: VentanaEliminarAerolinea.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaEliminarAerolinea.o VentanaEliminarAerolinea.cpp

${OBJECTDIR}/VentanaEliminarAvion.o: VentanaEliminarAvion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaEliminarAvion.o VentanaEliminarAvion.cpp

${OBJECTDIR}/VentanaEliminarCiudad.o: VentanaEliminarCiudad.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaEliminarCiudad.o VentanaEliminarCiudad.cpp

${OBJECTDIR}/VentanaEliminarHorario.o: VentanaEliminarHorario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaEliminarHorario.o VentanaEliminarHorario.cpp

${OBJECTDIR}/VentanaEliminarVuelo.o: VentanaEliminarVuelo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaEliminarVuelo.o VentanaEliminarVuelo.cpp
