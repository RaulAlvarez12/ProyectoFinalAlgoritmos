...
${OBJECTDIR}/ColaException.o: ColaException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColaException.o ColaException.cpp
...
${OBJECTDIR}/VentanaHorarios.o: VentanaHorarios.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaHorarios.o VentanaHorarios.cpp
